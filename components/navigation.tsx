...
const Navigation = () => {
  ...
  return (
    <header className=" flex items-center bg-background  border-b sticky top-0 px-4 md:px-8 z-50 h-16 gap-4">
      ...
      <div className="flex w-full items-center gap-4 md:ml-auto md:gap-2 lg:gap-4">
        <div className="ml-auto flex-1 sm:flex-initial">
          <div className="relative flex gap-x-5 text-sm font-semibold">
            <Link
              href="/topup"
              className={`${
                pathname === "/topup" ? "text-destructive" : ""
